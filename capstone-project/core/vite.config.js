...
const { AppBootModal } = require('./src/ui/components/AppBootModal/AppBootModal');
...
export default defineConfig(() => ({
  ...
  plugins: [
    ...
    federation({
      ...
      name: 'project_core',
      remotes: {
        project_fibonacci: "http://localhost:3001/mf-manifest.json",
        project_pow: "http://localhost:3002/mf-manifest.json",
      },
      shared: {
        '@emotion/react': {
          singleton: true,
